...
export const CARD_BORDER_DARK = "#gray.600";
export const TITLE_COLOR_LIGHT = "#111827";
export const TITLE_COLOR_DARK = "gray.100";
export const TEXT_COLOR_LIGHT = "#6B7280";
export const TEXT_COLOR_DARK = "gray.300";
